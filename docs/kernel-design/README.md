...
| [04-int8-footprint.md](04-int8-footprint.md) | INT8 vmfb 풋프린트 전수조사("8bit≠1/4"의 두 원인=임베딩 fp32 보존 + proj_out broken-tie) + 수정(tied Linear 양자화 제외 → 125→103MB, rel 0.8→0.61%, argmax 100%) + 크기 사다리 S0~S3 + Rust RSS 관계 |
