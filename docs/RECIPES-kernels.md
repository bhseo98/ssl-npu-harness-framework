...
> [RECIPES-zoo.md](RECIPES-zoo.md)가 *PyTorch→MLIR→.vmfb* 일반 lowering recipe라면,
...
(※ iree-compile는 riscv64 *컴파일* 가능. riscv64 IREE *런타임*은 미빌드 — VP 단계에서 크로스빌드. [RECIPES-vp.md](RECIPES-vp.md))
