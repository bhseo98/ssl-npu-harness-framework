...
> 본 문서는 외부 NPU compiler 측 (`design review note (internal)`) +
> PDF `internal-design-spec` + 사용자(collaborator) 의 2026-05-26 지시를
...
- `design review note (internal)` — 설계 노트 원문 (source-of-truth)
