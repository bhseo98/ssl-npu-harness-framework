...
|:---:|---|---|:---:|
| **1** | Naive Application Code (Python + PyTorch) on GPU Server — STT → LLM → TTS 한 turn | [`voice-app`](https://github.com/bhseo98/ssl-npu-harness-framework/tree/voice-app) | ✅ ([`docs/reports/2026-05-19-results.md`](docs/reports/2026-05-19-results.md)) |
