...
```bash
# tailscale 노드 gpu4-lab, 포트22 키 인증. 비밀번호는 채팅/문서에 쓰지 않는다.
ssh -o BatchMode=yes -o ConnectTimeout=12 bohyun@<gpu4-lab>   # 구체 IP는 로컬 메모리
...
ssh -t -L 8800:localhost:8800 bohyun@<gpu4-lab> /home/bohyun/run_demo.sh
