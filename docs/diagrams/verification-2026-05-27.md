...
flowchart LR
    ...
    R1["요구 ①<br/>프로젝트 의미 설명"]:::proc --> O1["✅ development.md §1-3<br/>+ (내부 문서) §1<br/>+ Plan (내부 문서) Context"]:::done
...
flowchart TD
    ...
    HEAD --> C1["(내부 문서)<br/>scripts/run_llama_export.py<br/>configs/zoo/llama_on_device_iree_turbine.yaml<br/>(내부 문서)"]:::committed
