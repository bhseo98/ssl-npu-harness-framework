...
[**Status board**](docs/archive/development.md) ·
[**Guidelines**](docs/guidelines.md) ·
[**Status**](docs/status.md) ·
[**Q&A/Decisions**](docs/decisions-qa.md) ·
[**Recipes**](docs/recipes/zoo.md): [zoo](docs/recipes/zoo.md) · [kernels](docs/recipes/kernels.md) · [VP](docs/recipes/vp.md) · [webui-mic](docs/recipes/webui-mic.md) ·
...
**import 0** — server-side ↔ on-device 매핑은 [`docs/SHARK_AI_ANALYSIS.md`](docs/archive/shark-ai-analysis.md) 의
표 reference.
...
> 클래스와 1:1 로 분해한 분석은 [`docs/easy-series/easy-all.md#sec-easy4-detail`](docs/easy-series/easy-all.md#sec-easy4-detail),
> 그림은 [`easy5-fig.md`](docs/easy-series/easy-all.md#sec-easy5-fig) + [`export-vs-lowering.drawio`](docs/diagrams/export-vs-lowering.drawio).
...
전체 architectural view — [`docs/ARCHITECTURE.md`](docs/archive/architecture.md).
주요 섹션:
...
실측 기반으로 풀어쓴 학습 노트. 처음이면 [`easy-sum.md`](docs/easy-series/easy-all.md#sec-easy-sum) (한 장 요약) 부터.

| 문서 | 한 줄 |
|---|---|
| [easy-sum](docs/easy-series/easy-all.md#sec-easy-sum) | 한 장 요약 — 제약 9종 ↔ 고칠 코드, "modelClass 교체 = 6개 동시 제거" 결론 |
| [easy](docs/easy-series/easy-all.md#sec-easy) / [easy2](docs/easy-series/easy-all.md#sec-easy2) | `LlamaOnDevice` MLIR→`.vmfb` 성공 / HF 모델 7종 입고 기준 |
| [easy3](docs/easy-series/easy-all.md#sec-easy3) | amdsharktank real Llama-3.2-1B export 제약 9종 → 1 근본원인 |
| [easy4](docs/easy-series/easy-all.md#sec-easy4) + [easy4-detail](docs/easy-series/easy-all.md#sec-easy4-detail) | export/lowering 에 쓴 클래스 27종 해부 + 실측 IR(27,269줄) op 1:1 매핑 |
| [easy5-fig](docs/easy-series/easy-all.md#sec-easy5-fig) | 그림판 — [`export-vs-lowering.drawio`](docs/diagrams/export-vs-lowering.drawio) (3페이지) |
