...
[![CI](https://github.com/bhseo98/ssl-npu-harness-framework/actions/workflows/ci.yml/badge.svg?branch=voice-app)](https://github.com/bhseo98/ssl-npu-harness-framework/actions/workflows/ci.yml)
...
See (내부 문서) for the full staging plan.
...
The on-device LLM implementation lives at [`src/torch_mlir_zoo/models/llama_on_device.py`](https://github.com/bhseo98/ssl-npu-harness-framework/blob/torch-mlir-zoo/src/torch_mlir_zoo/models/llama_on_device.py)
(171 LoC, RMSNorm + GQA + SwiGLU + RoPE, real HF gated weights loader). See
[`development.md`](https://github.com/bhseo98/ssl-npu-harness-framework/blob/torch-mlir-zoo/development.md)
on `torch-mlir-zoo` for the full PDF↔repo 1:1 status board and
[`docs/RECIPES-zoo.md`](https://github.com/bhseo98/ssl-npu-harness-framework/blob/torch-mlir-zoo/docs/RECIPES-zoo.md)
...
@software{npu_harness_framework_voice_app_2026,
  ...
  year    = {2026},
  url     = {https://github.com/bhseo98/ssl-npu-harness-framework/tree/voice-app}
}
```
