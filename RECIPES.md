...
### 12b) Manual full-repo review — REVIEW-BUNDLE.md

For big-picture sweeps (e.g. spec-vs-implementation audit), paste
**[REVIEW-BUNDLE.md](REVIEW-BUNDLE.md)** into ChatGPT-with-code, an
interactive `codex` session (`codex` then drop the bundle in), or any
code-aware LLM. The bundle contains:
- the original requirements (verbatim from the `CLAUDE-*.md` files)
...
- `docs/reports/2026-05-28-llm-tts-swap.md` — written report (figure-driven)
