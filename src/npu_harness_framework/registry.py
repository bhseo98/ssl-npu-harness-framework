"""Tiny registry — `@register("stt", "whisper")` + `build("stt", config)`.

Two-level dict: stage -> name -> class. `build` consumes the config dict's
`type` key to pick the class, and forwards the rest as kwargs.
"""
from __future__ import annotations

from typing import Any, Type

_REGISTRY: dict[str, dict[str, Type[Any]]] = {"stt": {}, "llm": {}, "tts": {}}
